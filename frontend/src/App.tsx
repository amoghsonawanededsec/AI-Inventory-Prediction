...
import DataInputStudioPage from './pages/DataInputStudioPage'
...
function App() {
  ...
  if (page === 'dashboard') view = <DashboardPage openDataStudio={() => setPage('data-input')} openChat={() => setPage('chat')}/>
  else if (page === 'data-input') view = <DataInputStudioPage/>
