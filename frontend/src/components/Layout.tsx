...
export type PageKey = 'dashboard' | 'data-input' | 'products' | 'inventory' | 'sales' | 'forecasts' | 'waste' | 'reorders' | 'orders' | 'suppliers' | 'analytics' | 'chat' | 'knowledge' | 'models' | 'admin' | 'users' | 'settings'
const links: { key: PageKey; label: string; icon: typeof Boxes; admin?: boolean }[] = [
  { key: 'dashboard', label: 'Overview', icon: BarChart3 }, { key: 'data-input', label: 'Data Input Studio', icon: FilePlus2 }, { key: 'products', label: 'Products', icon: Package }, { key: 'inventory', label: 'Inventory log', icon: Warehouse },
